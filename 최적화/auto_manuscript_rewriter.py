...
### 2. 첫 문단 규칙 ⚠️⚠️⚠️ (절대적 필수!)
**이 규칙을 어기면 완전 실패입니다!**

- **첫 문단에 통키워드 정확히 2회 출현**
  * 1회 ❌ 실패!
  * 2회 ✅ 성공!
  * 3회 ❌ 실패!

- **중요: 키워드 뒤에 조사 붙이면 카운팅 안 됨!**
  * "{keyword}를" → 카운팅 X
  * "{keyword} 관련해서" → 카운팅 O
...
### 3. 통키워드로 시작하는 문장 ⚠️⚠️⚠️ (전체 원고에서 정확히 2개!)
**이 규칙도 어기면 완전 실패입니다!**
...
- 올바른 예시 (조사 없음!):
  ```
  {keyword} 관련해서 고민이 많아 글을 올립니다.  ← 시작 1 ✅
...
1. ✅ 첫 문단에 통키워드 정확히 2회? (1회 ❌, 3회 ❌)
2. ✅ 전체 원고에서 통키워드로 시작하는 문장 정확히 2개? (0개 ❌, 1개 ❌, 3개 ❌)
3. ✅ 키워드 뒤에 조사 안 붙었나? ("{keyword}에", "{keyword}를" 같은 거 없나?)
4. ✅ 글자수 300~900자 범위 내?
5. ✅ 키워드 주제와 내용이 자연스럽게 일치?
