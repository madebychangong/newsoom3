...
- **검증:** 1번 ❌ / 2번 ✅ / 3번 ❌
- **중요: 키워드 뒤에 조사 붙으면 카운팅 안 됨!**
  * "{keyword}를" → 카운팅 X (조사 "를" 붙음)
  * "{keyword}에" → 카운팅 X (조사 "에" 붙음)
  * "{keyword} 관련해서" → 카운팅 O (띄어쓰기)
...
- **검증:** 0개 ❌ / 1개 ❌ / 2개 ✅ / 3개 ❌
- **예시:**
  * ✅ "{keyword} 관련해서 고민이 많아서..." (조사 없음)
  * ✅ "{keyword} 알아보다가 막막해서..." (조사 없음)
  * ❌ "{keyword}에 대해..." (조사 "에" 붙음)
