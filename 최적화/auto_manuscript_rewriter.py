...
⚠️ **핵심 원칙**: 원본의 내용, 톤, 자연스러움을 유지하면서 아래 규칙을 준수하세요.
...
1. **원본 존중**: 원본의 구조, 톤, 내용을 최대한 유지하세요
2. **자연스러움**: 기계적이지 않고 사람이 쓴 것처럼 자연스럽게
3. **최소 수정**: 규칙을 지키기 위해 필요한 부분만 수정하세요
4. **흐름 유지**: 문단 간 연결이 자연스럽게 이어지도록 하세요
...
⚠️ **중요**: 원본의 자연스러움과 내용은 유지하면서 규칙만 정확히 지키세요.
